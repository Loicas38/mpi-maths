...
\begin{proposition}{Propriétés valeur absolue}{}
    ...
    \begin{itemize}
        \item $\mid x \mid = 0$ ssi $x = 0$
        \item $ \mid xy \mid = \mid x \mid \mid y \mid$
        \item $\mid x + y \mid \leqslant \mid x \mid + \mid y \mid$
        \item $ \mid \mid x \mid - \mid y \mid \mid \leqslant \mid x + y \mid$
    \end{itemize}
\end{proposition}
...
\begin{exemple}
    ...
    $\mid a - b \mid \leqslant \varepsilon$ ssi $b - \varepsilon \leqslant a \leqslant b + \varepsilon$
...
\begin{theoreme}{Caractérisation séquentielle de la borne sup}{}
    ...
    Alors $\alpha = \sup A$ ssi il existe $(u_n)_{n \in \N}$ suite de $A$
...
\begin{definition}{distance dans $\R$}{}
    Soient $x, y \in \R$. On définit leur distance par $\text d (x, y) = \mid y - x \mid$
\end{definition}
...
\begin{proposition}{Seconde inégalité triangulaire}{}
    ...
    $$\mid N(u) - N(v) \mid \leqslant N(u + v)$$
    $$\mid N(u) - N(v) \mid \leqslant N(u - v)$$
\end{proposition}

\idee{
    Utiliser l'astuce $x - x$ pour faire apparaitre les bons termes, 
...
\begin{proof}
    ...
    Donc $\mid N(u) - N(v) \mid \leqslant N(u + v)$
...
\begin{proposition}{propriétés distance}{}
    ...
    \begin{enumerate}
        ...
        \item $d_N(\lambda u, \lambda v) = \mid \lambda \mid d_N(u, v)$
...
\subsubsection{Distance à une partie non vide}

\begin{definition}{Définition distance à une partie}{}
    Soit $(E, N)$ un espace vectoriel normé, avec $A \subset E$ non vide. 
    Soit $x \in E$. 

    On appelle distance de $x$ à $A$ et on note $d(x, A) = d_A(x)$ le réel positif
...
\begin{proposition}{Inégalité distance à une partie / entre deux points}{}
    ...
    $$\mid d_A(x) - d_A(y)\mid \leqslant d(x, y)$$
\end{proposition}

\idee{
    Astuce du topin, on fait apparaitre $y$ dans la distance entre $x$ et $a$.
}
...
\begin{definition}{Definition vecteur unitaire}{}
...
\begin{definition}{Barycentre (hors programme)}{}
